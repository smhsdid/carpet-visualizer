...
| Detail texture view | An ultra-close grazing macro view from about 8–15 degrees above the rug plane fills about 94–98% of the frame; the near binding side face is prominent and strong depth recession, near-to-far scale compression and gentle focus falloff are visible while central interlacing remains sharp | High camera position, weak surface recession, small binding side face, uniform yarn scale from near to far, camera too distant, excessive background, missing corner junction, or useful interlacing obscured by blur |
...
- Detail camera error: move the lens nearly level with the near binding to 8–15 degrees above the rug plane; require a prominent binding side face, strong depth recession and near-to-far scale compression.
