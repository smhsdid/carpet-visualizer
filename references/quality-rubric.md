...
| Relief and lustre | Raking light separates raised crowns from recessed channels with visible micro-shadow; taupe and ivory yarns have controlled warm soft-satin highlights without plastic glare or a global pale binder grid | Flat printed appearance, inflated beads, independent cords, washed-out ivory, plastic glare, or no visible raised/recessed separation |
