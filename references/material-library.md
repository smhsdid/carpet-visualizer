...
The original photographs are retained for audit and manual inspection. Their deterministic neutral derivatives preserve structure while reducing accidental palette transfer. Neutralisation does not make an image construction-neutral: use every image only for its declared role.
