...
Keep one integral woven system. For `jacquard-01`, the rug body is thin while short soft multi-filament folded or twisted floats form tapered, slightly irregular vertical crowns. Use two related crown scales: larger dominant crowns and smaller secondary crowns about 1.3–1.6 times narrower, naturally interleaved within one yarn family with slight variation in spacing, twist, and compression. Coarse vertical crowns remain dominant at about 55–65% visible surface exposure without closing the weave. Finer horizontal cross yarns remain continuously readable at about 25–35% through plain fields, motif interiors, narrow lines, and colour boundaries; fine vertical ground or anchoring threads occupy recessed channels. Each coarse float bends over the horizontal yarns, compresses at ties, and sinks back between crowns. Relief comes from this over-under path and soft compression, not from inflated beads or freestanding cords. Artwork lines are colour-region transitions inside this same weave: they may gain locally stronger relief from crown exposure, but the same short coarse crowns stay vertical through diagonal motifs, horizontal fine yarns cross every line, and no boundary becomes a smooth contour tube, independent piping, embroidery, or motif-following rope. Every visible yarn follows its local design-source colour. Use visible soft twist, light fibre fuzz, warm clean soft-satin strand highlights, moderate lustre, and a narrow rounded serged edge. The bundled generation inputs are already stored in upright finished-rug orientation. Fibre composition and manufacturing settings are unknown.
