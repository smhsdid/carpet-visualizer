...
```yaml
material_id: structured-woven-surface-01
display_name: "Structured Woven Surface 01"
construction: structured-woven-surface
default_for_design_only: true
status: task_reference_grounded_visual_profile
reference_strength_default: task_reference_grounded
render_branch: structured_woven_surface
